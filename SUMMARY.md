...
* [部署环境](chapter-2/deployment-env-setup/README.md)
  ...
  * [部署Kubernetes集群](chapter-2/deployment-env-setup/setup-kubernetes/README.md)
    * [使用Kubeadm部署Kubernetes集群](chapter-2/deployment-env-setup/setup-kubernetes/setup-kubeadm.md)
    * [使用Rancher建立Kubernetes集群](chapter-2/deployment-env-setup/setup-kubernetes/setup-rancher.md)
    * [使用Minikube安装Kubernetes集群](chapter-2/deployment-env-setup/setup-kubernetes/setup-minikube.md)
